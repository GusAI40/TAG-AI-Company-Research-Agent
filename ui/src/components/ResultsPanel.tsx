      ...
      <div className={`${glassStyle.card} equilibrium-panel space-y-8`}>
        ...
        {result && !error && (
          <div className="space-y-8">
            ...
            {deepResearchError && (
              <div className="rounded-2xl border border-[#8A1C33]/60 bg-[#8A1C33]/20 px-6 py-6 text-white">
                <h3 className="text-lg font-semibold">Gemini Deep Research unavailable</h3>
                <p className="mt-2 text-white/80">{deepResearchError}</p>
                <p className="mt-4 text-sm text-white/60">
            ...
            {deepResearch && (
              <div className="space-y-4 rounded-3xl border border-white/10 bg-white/5/10 p-6">
                <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                  <div>
                    <h3 className="text-2xl font-semibold text-white">Gemini Deep Research findings</h3>
                ...
                {deepResearch.summary && (
                  <p className="text-white/80 whitespace-pre-line">{deepResearch.summary}</p>
                )}
                {deepResearch.insights.length > 0 && (
                  <ul className="space-y-2 rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-white/80">
