...
function App() {
  ...
  const glassStyle: GlassStyle = useMemo(
    () => ({
      ...
      card: 'glass relative overflow-hidden rounded-3xl px-8 py-10 shadow-[var(--equilibrium-shadow)]',
      input:
        'glass w-full rounded-xl py-4 pl-12 pr-4 placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-[#0078D2]/60 focus:border-transparent transition-all',
    }),
    []
  );
