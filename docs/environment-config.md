...
| `GEMINI_DEEP_RESEARCH_MODEL` | Change the Gemini Deep Research model (defaults to `gemini-2.0-flash`; PitchGuard automatically retries `gemini-2.0-pro`, `gemini-2.5-flash`, and `gemini-2.5-pro` if a model returns 404/400). |
