...
Every metric, quick stat, takeaway, watch item, and diligence question must include a "source" value made up of comma-separated https URLs drawn directly from the provided sources (no descriptive text). If a direct URL is not available, fall back to comma-separated source indices such as "#1".
