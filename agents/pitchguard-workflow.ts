...
export const webResearchAgent = new Agent({
  ...
  instructions:
    [
      ...
      "Keep summary_hook under 20 words and write watch_items + diligence_questions so that finance students can benchmark a live pitch immediately.",
...
export const summarizeAndDisplay = new Agent({
  ...
  instructions:
    [
      ...
      "Reuse the research metrics so scoreboard sections stay factual and keep the section titles aligned with Growth, Profitability, Balance Sheet & Liquidity. Diligence questions should make it easy to challenge a stock pitch.",
      reactInstructionSuffix,
    ].join(' '),
  model: "gpt-5",
